	...
	themeConfig: {
		locales: {
			'/': {
				...
				nav: [
					{ text: 'Home', link: '/' },
					{ text: 'Report', link: 'https://njzjz.github.io/reacnetgenerator/report.html?jdata=simple.json' },
			...
			'/zh/': {
				...
				nav: [
					{ text: '主页', link: '/zh/' },
					{ text: '分析结果', link: 'https://njzjz.github.io/reacnetgenerator/report.html?jdata=simple.json' },
